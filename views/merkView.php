        			...
        			<div class="modal-dialog">
        				...
        				<div class="modal-content">
        					<div class="modal-header">
        						...
        						<h2 class="modal-title">Merk</h2>
        					</div>

        					<div class="modal-body">
        						<input type="hidden" class="form-control"  name="merk_id" id="merk_id" >
        	...
        	$(document).ready(function () {
        		...
        		var dataTable = $('#table-grid').DataTable( {
        			...
        			"ajax":{
        				...
        				data:{action:'view'},
        				// url :"table-grid-data.php", // json datasource
